...
if __name__ == '__main__':
    ...
    if args.model_name == 'tfidf':
        ...
        if args.train :
            ...
            print("Evaluating performance on dev data...")
            MAP, MRR, P1, P5, auc5 = train_utils.evaluate(model_data=dev, model=model, cuda=args.cuda)
            print(tabulate([[MAP, MRR, P1, P5, auc5]], headers=['MAP', 'MRR', 'P@1', 'P@5', 'AUC0.05']))

            print()
            print("Evaluating performance on test data...")
            MAP, MRR, P1, P5, auc5 = train_utils.evaluate(model_data=test, model=model, cuda=args.cuda)
            print(tabulate([[MAP, MRR, P1, P5, auc5]], headers=['MAP', 'MRR', 'P@1', 'P@5', 'AUC0.05']))
